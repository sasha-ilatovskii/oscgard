...
| **Mod Core** | `lib/mod.lua` | OSC routing, slot management, device lifecycle, zeroconf discovery, mod menu |
...
│   ├── mod.lua              # Mod core: OSC routing, discovery, menu, lifecycle
